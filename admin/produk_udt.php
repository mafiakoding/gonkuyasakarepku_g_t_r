...
$error='';
  ...
  if (isset($_POST['submit'])) {
    ...
    if (!empty(trim($kd)) && !empty(trim($nm)) && !empty(trim($hrg)) && !empty(trim($jml)) && !empty(trim($berat)) && !empty(trim($_FILES["gambar"]["tmp_name"]))) {
      $target_dir = "gambar/";
      $target_dir2 = "../gambar/";
      $target_file = $target_dir . basename($_FILES["gambar"]["name"]);
      $target_file2 = $target_dir2 . basename($_FILES["gambar"]["name"]);
      $uploadOk = 1;
      ...
      if (ed_pr($kd,$nm,$hrg,$jml,$berat,$target_file)) {
        ...
        <div class="main-content-inner">
            <div class="row">
              <div class="col-xs-12">
                <div class="row">
                    <div class="col-lg-12">
                      <center> <h3 class="page-header">Add Stock Produk</h3></center>
                    </div>
                </div>
                <div id="wrapper">
                ...
                <table class="table">
                  <form class="" action="" method="post" enctype="multipart/form-data">
                    ...
                    <input type="text" name="kd" readonly="readonly" value="<?=$kd_a; ?>"><br><br>
                    ...
                    <input type="text" name="jumlah" value="<?=$jml_a; ?>"><br><br>

                    <label for="berat">Berat</label><br>
                    <input type="text" name="berat" value="<?=$brt_a; ?>"><br><br>
