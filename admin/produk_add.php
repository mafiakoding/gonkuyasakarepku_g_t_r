...
$error='';
  ...
  if (isset($_POST['submit'])) {
    ...
    if (!empty(trim($kd)) && !empty(trim($nm)) && !empty(trim($hrg)) && !empty(trim($jml)) && !empty(trim($berat)) && !empty(trim($_FILES["gambar"]["tmp_name"]))) {
      ...
      if (tmb_dt_pr($kd,$nm,$hrg,$jml,$berat,$target_file)) {
        ...
        <div class="main-content-inner">
            <div class="row">
              <div class="col-xs-12">
                <div class="row">
                    <div class="col-lg-12">
                      <center> <h3 class="page-header">Add Produk</h3></center>
                    </div>
                </div>
                <div id="wrapper">
                ...
                <table class="table">
                 <form class="" action="" method="post" enctype="multipart/form-data">
                   ...
                   <input type="text" readonly="readonly" name="kd" value="<?=$hasilkode?>"><br><br>
                   ...
                   <input type="text" name="jumlah" value=""><br><br>
