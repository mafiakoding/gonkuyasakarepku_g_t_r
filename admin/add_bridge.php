...
$error='';
$carikode = mysqli_query($con,"SELECT MAX(kd_bridge) FROM bridge") ;
...
$date = date("y-m-d");
   if ($datakode) {
    ...
    $kode = (int) $nilaikode;
    $kode = $kode + 1;
    $hasilkode = "br_".str_pad($kode, 3, "0", STR_PAD_LEFT);
   } else {
    $hasilkode = "br_001";
   }
  ...
  if (isset($_POST['submit'])) {
    ...
    if (!empty(trim($kd)) && !empty(trim($nm)) && !empty(trim($hrg)) && !empty(trim($mrk)) && !empty(trim($_FILES["gambar"]["tmp_name"]))) {
      ...
      if (tmb_dt_br($kd,$nm,$hrg,$jml,$mrk,$target_file)) {
        ...
        <div class="main-content-inner">
            <div class="row">
              <div class="col-xs-12">
                <div class="row">
                    <div class="col-lg-12">
                      <center> <h3 class="page-header">Add Stock Bridge</h3></center>
                    </div>
                </div>
                <div id="wrapper">
