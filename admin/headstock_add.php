...
$error='';
$carikode = mysqli_query($con,"SELECT MAX(kd_headstock) FROM headstock") ;
...
$date = date("y-m-d");
   if ($datakode) {
    ...
    $kode = (int) $nilaikode;
    $kode = $kode + 1;
    $hasilkode = "hs_".str_pad($kode, 3, "0", STR_PAD_LEFT);
   } else {
    $hasilkode = "hs_001";
   }
  ...
  if (isset($_POST['submit'])) {
    ...
    if(tmb_dt_hs($kd,$nm,$hrg,$jml,$mrk,$target_file)) {
        ...
        <div class="main-content-inner">
            <div class="row">
              <div class="col-xs-12">
                <div class="row">
                    <div class="col-lg-12">
                      <center> <h3 class="page-header">Add Stock Headstock</h3></center>
                    </div>
                </div>
                <div id="wrapper">
